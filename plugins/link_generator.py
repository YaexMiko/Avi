...
async def batch(client: Client, message: Message):
    ...
    await second_message.reply_text(f"<b><bold>🧑‍💻 𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙲𝚘𝚍𝚎.\n\n<code>{base64_string}</bold></code></b>\n<b><bold>📤𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙻𝚒𝚗𝚔📥</bold>\n{link}", quote=True, reply_markup=reply_markup)
...
async def link_generator(client: Client, message: Message):
    ...
    await channel_message.reply_text(f"<b><bold>🧑‍💻 𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙲𝚘𝚍𝚎.</bold>\n<code><bold>{base64_string}</bold></code></b>\n<b><bold>📤𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙻𝚒𝚗𝚔📥</bold></b>\n<bold>{link}</bold>", quote=True, reply_markup=reply_markup)
